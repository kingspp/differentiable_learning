...
i \leftarrow \textit{Number of layers}
 ...
 \While{i $<$ 0}{
  \textit{layer}\gets\ \textit{pruner}\textit{(layer}\textsuperscript{(i)}, \textit{prune nodes}\textsuperscript{(i)}\textit{)}\

}
 
 \Procedure {pruner}{$layer, nodes$}
