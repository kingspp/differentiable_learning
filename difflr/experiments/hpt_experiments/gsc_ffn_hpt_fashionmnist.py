...
def main():
    ...
    config = {
        'model_name': 'fashion_mnist_gsc_tuned_adam_100p_data_100p_params',
        "num_classes": 10,
        'in_features': 784,
        'epochs': 100,
        'batch_size': [256],
    ...
    start_time = time.time()
    config = {
        'model_name': 'fashion_mnist_gsc_tuned_adam_100p_data_10p_params',
        "num_classes": 10,
        'in_features': 784,
        'epochs': 100,
        'batch_size': [256],
    ...
    start_time = time.time()
    config = {
        'model_name': 'fashion_mnist_gsc_tuned_adam_10p_data_100p_params',
        "num_classes": 10,
        'in_features': 784,
        'epochs': 100,
        'batch_size': [32],
    ...
    start_time = time.time()
    config = {
        'model_name': 'fashion_mnist_gsc_tuned_adam_10p_data_10p_params',
        "num_classes": 10,
        'in_features': 784,
        'epochs': 100,
        'batch_size': [256],
