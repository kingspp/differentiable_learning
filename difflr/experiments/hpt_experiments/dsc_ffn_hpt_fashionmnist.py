...
def main():
    ...
    config = {
        'model_name': 'fashionmnist_dscffn_tuned_SGD_100p_params_100p_data',
        "num_classes": 10,
        'in_features': 784,
        'epochs': 100,
        'batch_size': [32],
    ...
    start_time = time.time()
    config = {
        'model_name': 'fashionmnist_dscffn_tuned_SGD_10p_params',
        "num_classes": 10,
        'in_features': 784,
        'epochs': 100,
        'batch_size': [32],
    ...
    start_time = time.time()
    config = {
        'model_name': 'fashionmnist_dscffn_tuned_SGD_10p_data',
        "num_classes": 10,
        'in_features': 784,
        'epochs': 100,
        'batch_size': [32],
    ...
    start_time = time.time()
    config = {
        'model_name': 'fashionmnist_dscffn_tuned_SGD_10p_params_10p_data',
        "num_classes": 10,
        'in_features': 784,
        'epochs': 100,
        'batch_size': [32],
